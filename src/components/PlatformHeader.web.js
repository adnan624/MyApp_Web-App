...
const styles = StyleSheet.create({
  ...
  text: { fontSize: 12, color: '#06b6d4', fontWeight: '700', letterSpacing: 0.3 },
  divider: { color: '#334155', fontSize: 14 },
  meta: { fontSize: 12, color: '#64748b', fontWeight: '500', fontFamily: 'monospace' },
});
