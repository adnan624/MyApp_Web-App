    ...
    <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent}>
            ...
            <View style={styles.heroActions}>
              ...
              <View style={styles.platformPill}>
                <Text style={styles.platformPillText}>
                  {PLATFORM_EMOJI[Platform.OS]}  {Platform.OS}
                </Text>
              </View>
            </View>
          </View>
      ...
      <View style={[styles.section, isWide && styles.sectionWide]}>
        <View style={styles.platformBanner}>
          ...
          <Text style={styles.platformBigEmoji}>{PLATFORM_EMOJI[Platform.OS]}</Text>
        </View>
      </View>
...
const PLATFORM_EMOJI = { ios: '🍎', android: '🤖', web: '🌐' };
...
const styles = StyleSheet.create({
  ...
  heroInner:     { maxWidth: 520, width: '100%', alignSelf: 'center' },
  heroInnerWide: { maxWidth: 1100, flexDirection: 'row', alignItems: 'center', gap: 60 },
  heroLeft:      { flex: 1 },
  heroLeftWide:  { flex: 1 },
  ...
  heroBadgeText: { fontSize: 12, color: C.cyan, fontWeight: '600', letterSpacing: 0.5 },
  ...
  heroCTAText:   { color: '#000', fontSize: 14, fontWeight: '800' },
  platformPill: {
    backgroundColor: C.surfaceHi, borderWidth: 1, borderColor: C.border,
    paddingVertical: 12, paddingHorizontal: 16, borderRadius: 10,
  },
  platformPillText: { color: C.white, fontSize: 13, fontWeight: '600' },
  ...
  heroImageTint: {
    position: 'absolute',
    top: 0, left: 0, right: 0, bottom: 0,   // ← explicit instead of inset:0
  ...
  heroImageBadgeText: { color: C.cyan, fontSize: 11, fontWeight: '700' },
  ...
  statNum:        { fontSize: 30, fontWeight: '900', color: C.cyan, letterSpacing: -1 },
  statLabel: {
  ...
  // Sections
  section:     { paddingHorizontal: 24, paddingTop: 56, maxWidth: 1100, width: '100%', alignSelf: 'center' },
  ...
  cardTitle:    { fontSize: 15, fontWeight: '700', color: C.white, marginBottom: 6 },
  ...
  platformBannerOS: {
    fontSize: 44, fontWeight: '900', color: C.cyan,
  ...
  techChipName: { fontSize: 13, fontWeight: '700', color: C.white },
  ...
  footerSub: {
    ...
    textAlign: 'center', maxWidth: 420, marginBottom: 28,
  },
  footerBtn: {
    backgroundColor: C.cyan,
    paddingVertical: 14, paddingHorizontal: 32, borderRadius: 10,
  },
  footerBtnText: { color: '#000', fontSize: 14, fontWeight: '800' },
});
